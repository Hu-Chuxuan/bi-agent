...
Note: before you operate on any column, you have to transform the column into numeric values if possible. THIS IS VERY IMPORTANT BEFORE YOU APPLY ANY NUMERIC FILTERS.
