...
def execute_tool(tool_call, queries, id, conn, temp_folder, data_list, transform_method):
    ...
    if tool_name == "retrieve_relevant_tables":
        ...
        execution_res = tool_fn(id, temp_folder, data_list, transform_method)
    else:
    ...
    for transformation_name, table_list in transformations.items():
        ...
        for table_name in table_list:
            ...
            try:
                ...
                df_after.to_csv(original_path, index=False)
...
def discover_join_relationships(id, temp_folder, data_list, transform_method):
