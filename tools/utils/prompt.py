...
**Note:** before you operate on any column, you have to transform the column into numeric values if possible.
...
TOOLS_SQL = [
            ...
            "parameters": {
                ...
                "properties": {
                    "code": {
                        "type": "string",
                        "description": (
                            "The SQL code to execute. *** IMPORTANT ***: When using SELECT to view table contents, "
                            "you HAVE TO add LIMIT 5 to prevent exceeding context limit. SQLite uses double quotes "
                            "for table names and column names: SELECT \"column name\" FROM \"table name\"; "
                            "But we have processed table names and column names for you so that you can access them "
                            "without quoting."
                        ),
                    }
                },
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "*** IMPORTANT ***: There are so many input tables, most are NOT relevant to the query, making it hard "
                "to identify the necessary information to answer the query. This tool allows you to retrieve only "
                "tables actually relevant to the query."
            ),
            "parameters": {
                "type": "object",
                "properties": {},
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "*** IMPORTANT ***: There are so many input tables, identifying what tables join with what tables can "
                "be hard. This tool allows you to get all joins between input tables (i.e., what tables can be joined, "
                "between what columns). This function also checks if there are missing intermediate tables that are "
                "implicitly required to join the selected tables and will output the final required table list."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "table_list": {
                        ...
                        "items": {"type": "string"},
                        "description": (
                            "List of tables to discover join relationships (ideally the tables selected that are "
                            "necessary to answer user query). If unknown, pass an empty list []."
                        ),
                    }
                },
                # strict mode: must include every key in properties
                "required": ["table_list"],
                "additionalProperties": False,
            },
        },
    },
    {
        ...
        "function": {
            ...
            "description": (
                "*** IMPORTANT ***: Some tables are not relational and processing them at scale can be hard. "
                "This tool allows you to transform all tables that are not relational using operations like transpose, "
                "pivot, and unpivot."
            ),
            "parameters": {
                "type": "object",
...
TOOLS_PY = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "*** IMPORTANT ***: There are so many input tables, most are NOT relevant to the query, making it hard "
                "to identify the necessary information to answer the query. This tool allows you to retrieve only tables "
    ...
    },
    {
        ...
        "function": {
            "name": "discover_join_relationships",
            "description": (
                "*** IMPORTANT ***: There are so many input tables, identifying what tables join with what tables can be hard. "
                "This tool allows you to get all joins between input tables (i.e., what tables can be joined, between what columns). "
                "This function also checks if there are missing intermediate tables that are implicitly required to join the selected tables "
                "and will output the final required table list."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "table_list": {
                        ...
                        "items": {"type": "string"},
                        "description": (
                            "List of tables to discover join relationships (ideally the tables selected that are necessary to answer user query). "
                            "**IMPORTANT:** The csv tables should be provided as the full table path. If unknown, pass []."
                        ),
                    }
                },
                "required": ["table_list"],
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "*** IMPORTANT ***: Some tables are not relational and processing them at scale can be hard. "
                "This tool allows you to transform all tables that are not relational using operations like transpose, pivot, and unpivot."
            ),
            "parameters": {
                "type": "object",
                "properties": {},
...
**Again, whenever you decide to call any functions, WRAP THEM INTO JSON FORMAT!! DON"T just say you would like to call any functions**

**Again, you MUST ASSUME USER INPUTS ARE SUFFICIENT and answer the query by calling functions. Start your response with FUNCTION CALLS rather than excuses like 'Your input is not sufficient.'**
"""
    + """
    Here is a list of functions in JSON format that you can invoke.\n
    """
    + """
    **IMPORTANT: All these provided functions are sufficient for you to answer user query, and you should keep calling them until you get a valid result.**
    **Again, whenever you decide to call any functions, WRAP THEM INTO JSON FORMAT!! DON"T just say you would like to call any functions**
    **Again, you MUST ASSUME USER INPUTS ARE SUFFICIENT and answer the query by calling functions. Start your response with FUNCTION CALLS rather than excuses like 'Your input is not sufficient.'**
    """
)