...
import utils.caller_large_models as caller
...
def main(folder_id: str, model: str, language: str, tool: bool, log_path: str):
    ...
    if caller.is_open_source(model):
    ...
    for i in range(1, 31):
        ...
        if caller.is_open_source(model):
            ...
            for tc in message.tool_calls:
                ...
                if tmp_res is not None:
                    result = tmp_res
                input_messages.append(caller.format_tool_turn_proprietary(tc, res_result))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", required=True, choices=sorted(caller.ALL_MODELS), help="Model name")
